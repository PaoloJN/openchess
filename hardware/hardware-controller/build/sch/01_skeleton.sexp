	(paper "A2")
	(title_block
		(title "OpenChess — Controller Board")
		(date "2026-06-04")
		(rev "0.1")
		(company "Paolo Nessim")
		(comment 1 "ESP32 controller + power + matrix scan drivers")
		(comment 2 "J_MAIN mates to matrix-board J_CTRL")
	)
	(lib_symbols
		(symbol "Device:R"
			(pin_numbers
		...
		(symbol "Regulator_Linear:AP2204K-1.5"
			...
			(property "Datasheet" "https://www.diodes.com/assets/Datasheets/AP2204.pdf"
				(at 0 2.54 0)
				(show_name no)
				(do_not_autoplace no)
				(hide yes)
			...
			(property "Description" "150mA low dropout linear regulator, wide input voltage range, 1.5V fixed positive output, SOT-23-5"
				(at 0 0 0)
				(show_name no)
				(do_not_autoplace no)
				(hide yes)
	...
	(text "OpenChess — Controller Board"
		(exclude_from_sim no)
		(at 30 28 0)
		(effects (font (size 6.0 6.0) (bold yes)) (justify left bottom))
		(uuid "deca0001-0000-4000-8000-000000000001")
	)
	(text "Controller PCB: power, ESP32, row pullups, column drivers, LED data, user UI"
		(exclude_from_sim no)
		(at 30 37 0)
	...
	(rectangle
		(start 380 170) (end 566 285)
		(stroke (width 0.2) (type default))
		(fill (type none))
		(uuid "deca001c-0000-4000-8000-00000000001c")
	)
	(text "USER UI CONNECTOR"
		(exclude_from_sim no)
		(at 383 168 0)
		(effects (font (size 2.5 2.5) (bold yes)) (justify left bottom))
		(uuid "deca001d-0000-4000-8000-00000000001d")
	)
	(text "Cable-mounted side controls\nStatus LEDs and buttons live off-board\nPinout pending"
		(exclude_from_sim no)
		(at 384 175 0)
		(effects (font (size 1.5 1.5)) (justify left top))
		(uuid "deca001e-0000-4000-8000-00000000001e")
	)
	(rectangle
		(start 28 305) (end 566 400)
		(stroke (width 0.2) (type default))
		(fill (type none))
		(uuid "deca001f-0000-4000-8000-00000000001f")
	)
	(text "TEST + MECHANICAL"
		(exclude_from_sim no)
		(at 31 303 0)
		(effects (font (size 2.5 2.5) (bold yes)) (justify left bottom))
		(uuid "deca0020-0000-4000-8000-000000000020")
	)
	(text "Testpoints for rails, matrix connector nets, drivers\n4x M3 mounting holes\n3x fiducials for assembly"
		(exclude_from_sim no)
		(at 32 310 0)
		(effects (font (size 1.5 1.5)) (justify left top))
		(uuid "deca0021-0000-4000-8000-000000000021")
	)
