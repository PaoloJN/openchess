...
# ──────────────────────────────────────────────────────────────────────────────
SQUARE_SIZE  = 32        # mm per chess square (matches folding board model)
BOARD_MARGIN = 18        # mm from outermost chess square corner to PCB edge.
                         # Physical model has 20 mm inner-frame margin (notation
                         # area). 18 mm leaves ~2 mm wiggle per side so the PCB
                         # can slide inside the 20 mm cavity.
